"""Blackjack, By Pat Pancake
The classic card game also known as 21. (This version doesn't 
have splitting or insurance.)
...
def main():
    print(""" Blackjack, by Pat Pancake
...
def getMove(playerHand, money):
    """Asks th eplayer for their move, and returns "H" for hit,
