"""Bouncing dvd logo, by Pat Pancake
A bouncing DVD logo animation. You have to be "of certain of age"
to appreciate this. Press Ctrl-C to stop.
...
NUMBER_OF_LOGOS = 20 # (!) Try changing this to 1 or 100.
PAUSE_AMOUNT = 0.4 # (!) Try changing this to 1.0 or 0.0.
...
if __name__ == "__main__":
    try:
        ...
        print()
        print("Bouncing DVD logo, by Pat Pancake")
